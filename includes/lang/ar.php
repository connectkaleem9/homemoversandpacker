...
return [
    ...
    'cta.view_project'    => 'شاهد التفاصيل',
    'cta.write_review'    => 'اكتب رأيك',

    'form.rating'         => 'تقييمك',
    'form.rating_of'      => '{n} من 5',
    'form.city'           => 'منطقتك',
    'form.service_used'   => 'أي خدمة قدمناها لك؟',
    'form.review'         => 'رأيك',
    'form.review_ph'      => 'ما الذي نقلناه، وكيف سار اليوم؟ التفاصيل هي ما يفيد العميل التالي.',
    'form.review_submit'  => 'أرسل رأيي',
    'form.review_legal'   => 'ننشر اسمك الأول ومنطقتك ورأيك. أما بريدك الإلكتروني ورقم هاتفك فيبقيان خاصين ويُستخدمان فقط للتأكد من أن الرأي حقيقي. راجع',
    'form.review_contact_hint' => 'زوّدنا ببريد إلكتروني أو رقم هاتف حتى نتأكد من أن الرأي حقيقي. لا يُنشر أي منهما.',

    'err.rating'          => 'اختر تقييماً من نجمة إلى خمس نجوم.',
    'err.review_short'    => 'يرجى كتابة المزيد — جملة أو جملتين على الأقل.',
    'err.review_contact'  => 'زوّدنا ببريد إلكتروني أو رقم هاتف حتى نتمكن من التحقق من الرأي.',
    'err.check_review'    => 'يرجى مراجعة الحقول المُعلَّمة وإرسال الرأي مرة أخرى.',

    'flash.review_thanks' => 'شكراً لك على كتابة هذا.',
    'lead.review_ok'      => 'تم استلام رأيك. نتحقق من أن كل رأي حقيقي قبل نشره على الموقع، لذا سيظهر قريباً.',
